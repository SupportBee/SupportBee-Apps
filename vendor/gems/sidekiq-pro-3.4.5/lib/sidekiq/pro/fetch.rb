    ...
    class Retriever
      ...
      def startup
        watchdog("ReliableFetch#startup") do
          ...
          Sidekiq.logger.info("ReliableFetch is deprecated, super_fetch will become the new reliable_fetch in Pro 4.0.")
          Sidekiq.logger.info("See https://github.com/mperham/sidekiq/wiki/Pro-Reliability-Server")
